...
1. **Connect QGC:**
   - On the same device, open MAVLab and switch to QGC within one minute (QGC connects over `127.0.0.1:14550`; split-screen is optional), or open QGC on a desktop PC on the same Wi-Fi.
